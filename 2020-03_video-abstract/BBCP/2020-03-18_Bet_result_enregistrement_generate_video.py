...
def video():
    ...
    # setup values
    # ---------------------------------------------------
    screen_width_px = 1314 # 885 #800#/1.618
    screen_height_px = 881 # 589 # 500#/1.618
    framerate = 40
    ...
    for num_fig in range(1, len(fileList)+1) :
        fig = visual.ImageStim(win, os.path.join(folder, '2_results_enregistrement_%s.png' % num_fig))
