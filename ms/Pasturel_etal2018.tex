...
of the dynamics of the complex system constituted by the atmosphere.
Based on past history and prior knowledge about
the effect of our own emissions of carbon dioxid,
one should be able to predict if either
...
As such, it is essential to infer near future state in a dynamic environment ---
or at least to form beliefs as precise as possible about a future environmental context.
