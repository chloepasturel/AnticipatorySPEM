...
in the direction of the bias and before any visually-guided component:
...
to study the trial-by-trial evolution
...
%: in summary we get a linear relationship (talk about santos & kowler and others)
...
predicted and anticipated with coherent orienting eye movements~(\seeFig{intro}-B).
...
it seems important to investigate the integration of environmental statistical regularities
