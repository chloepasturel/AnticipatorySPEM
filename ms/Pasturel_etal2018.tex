...
the trace of the rating scale correlates well
with the inferred probability $\hat{p}$.
Similarly to the strength of aSPEM,
this traces exhibits also
Note that at every pause (black vertical bar),
...
we now compare the value of rating scale
...
but which following a non-linear trace.
