...
%: using \hat{p} as a regressor / limits of the leaky integrator
...
% --------------------------------------------------------------------------------------
%: overcoming this difficulty using a latent variable= run-length / fundamental in bayesian methods / message passing
