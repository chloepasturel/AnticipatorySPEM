...
\subsection*{<<Bet>>}
In this first part, the subjects must simply answer before each test the question \textit{<<At what point are you sure that the point will go left or right?>>}

\subsection*{<<Recording>>}
Then we recorded their eye movements when it was only watching that same sequence.
