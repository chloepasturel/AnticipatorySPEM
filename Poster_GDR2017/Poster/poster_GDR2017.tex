%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\AuthorA}{Chloé Pasturel$^1$}
\newcommand{\AuthorB}{Jean-Bernard Damasse$^1$}%
\newcommand{\AuthorC}{Anna Montagnini$^1$}%
\newcommand{\AuthorD}{Laurent U.~Perrinet$^1$}%

\newcommand{\Address}{$^1$Institut de Neurosciences de la Timone, CNRS / Aix-Marseille Université - Marseille, France}%
...
\vspace{0.5cm}
\begin{center}
\includegraphics[width=1\columnwidth]{image_anna_1}
\end{center}
\vspace{0.5cm}
\begin{center}
\includegraphics[width=1\columnwidth]{image_anna_2}
\end{center}
...
when we delete the first 15 trials after the switches, it gives :
...
\begin{itemize}\setlength{\itemsep}{0ex}
\item There is a strong correlation between the Real Probability and the Probability Bet

\item There is a lower correlation between the Acceleration of anticipation and the Real Probability, and between the Acceleration of anticipation and the Probability Bet

\end{itemize}

Analysis more advanced is in progress in order to obtain more significant results.
