...
\columnbreak
Let's plot the acceleration of anticipation (slope of aSPEM) refocused on the mean of the acceleration for each subject as a function of the real probability at every given trial :
...
We now compare the probability bet during the bet with the refocused acceleration of anticipation during the recording (we omit the first 15 trials after the switches) :
