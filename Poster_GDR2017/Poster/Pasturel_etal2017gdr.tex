...
We now compare the probability bet during the bet with the acceleration of anticipation during the recording (we omit the first 15 trials after the switches) :
