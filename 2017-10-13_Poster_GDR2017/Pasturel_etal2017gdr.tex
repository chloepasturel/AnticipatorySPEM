...
\newcommand{\Conference}{\textbf{GDR Vision 2017}, Lille, France - code and material @ \url{http://invibe.net/LaurentPerrinet/Publications/Pasturel17gdr} \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\ Acknowledgments : ANR grant <<Reinforcement and Eye Movements>> \textbf{ANR-13-APPR-0008-02}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{center} 
    \includegraphics[width=1\columnwidth]{p_real--v_a_15}
\end{center}
...
We now compare the value of bet during the bet experiment with the acceleration of anticipation during the recording (we omit the first 15 trials after the switches) :
...
\begin{center} 
    \includegraphics[width=1\columnwidth]{p_bet--v_a_15}
\end{center}
