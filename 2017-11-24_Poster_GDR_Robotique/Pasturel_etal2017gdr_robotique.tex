...
We have adapted Adams and Mackay's Bayesian Online Changepoint Detection model~\parencite{AdamsMackay2007} to model an agent behaving like the subject. For the third blocks we have these results:
...
%\subsection*{Bayesian change point}
\subsection*{Relating Bayesian change point and results}


We now compare the value of bet during the bet experiment and the acceleration of anticipation during the recording with the value obtained with of model :
